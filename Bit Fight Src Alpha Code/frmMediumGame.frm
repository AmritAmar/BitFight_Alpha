VERSION 5.00
Begin VB.Form frmMediumGame 
   BackColor       =   &H00000000&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "The Game - Medium!"
   ClientHeight    =   7965
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   14280
   ...
   End
End
Attribute VB_Name = "frmMediumGame"
...
Dim d As Integer 'Enemy's Square X co-ordinates
